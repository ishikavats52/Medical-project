      ...
      <div className="container-fluid bg-dark text-light mt-5 py-5">
        <div className="container py-5">
          <div className="row g-5">
            ...
            <div className="col-lg-3 col-md-6">
              ...
              <div className="d-flex flex-column justify-content-start">
                <a className="text-light mb-2" href="#"><i className="fa fa-angle-right me-2"></i>Home</a>
                <a className="text-light mb-2" href="#"><i className="fa fa-angle-right me-2"></i>About Us</a>
                <a className="text-light mb-2" href="#"><i class="fa fa-angle-right me-2"></i>Our Services</a>
                <a className="text-light mb-2" href="#"><i class="fa fa-angle-right me-2"></i>Meet The Team</a>
                <a className="text-light" href="#"><i class="fa fa-angle-right me-2"></i>Latest Blog</a>
              </div>
            </div>
          ...
          <div className="d-flex">
            ...
            <div className="d-flex">
              <a className="btn btn-lg btn-primary btn-lg-square rounded-circle me-2" href="#"><i class="fab fa-twitter"></i></a>
              <a className="btn btn-lg btn-primary btn-lg-square rounded-circle me-2" href="#"><i class="fab fa-facebook-f"></i></a>
              <a className="btn btn-lg btn-primary btn-lg-square rounded-circle me-2" href="#"><i class="fab fa-linkedin-in"></i></a>
              <a className="btn btn-lg btn-primary btn-lg-square rounded-circle me-2" href="#"><i class="fab fa-instagram"></i></a>
            </div>
          </div>
        </div>
      </div>
